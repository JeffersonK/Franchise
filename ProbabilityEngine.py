...
#
###############################################
gsBATTERSKILLS_MAXPATIENCE = 100.0
gsBATTERSKILLS_MINPATIENCE = 0.0
gsBATTERSKILLS_NUMPATIENCE_LEVELS = gsBATTERSKILLS_MAXPATIENCE - gsBATTERSKILLS_MINPATIENCE 
gsBC_PROB_WORSTPATIENCE_SWING = 0.18
gsBC_PROB_BESTPATIENCE_SWING = 0.03
gsPROBDELTA_BESTWORST_PATIENCE_SWING = gsBC_PROB_WORSTPATIENCE_SWING - gsBC_PROB_BESTPATIENCE_SWING
...
gsBC_PROB_WORSTPITCHER_BALL = 0.60
