...
#Position Codes (INTs)
gsPITCHER_POSCODE,gsCATCHER_POSCODE,gsFIRSTBASE_POSCODE, gsSECONDBASE_POSCODE, gsTHRIDBASE_POSCODE, gsSHORTSTOP_POSCODE, gsLEFTFIELDER_POSCODE, gsCENTERFIELDER_POSCODE, gsRIGHTFIELDER_POSCODE, gsDESIGNATEDHITTER_POSCODE = range(1,11)
