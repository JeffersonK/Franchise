...
class GameState:
    ...
    def __str__(self):
        header    =  "--- H:%d A:%d in %s of %d %d outs ---\n" % (self.__HomeTeam.getRunsScored(), 
                                                                  self.__AwayTeam.getRunsScored(), "bottom" if self.__homeTeamUp else "top", self.__inning, 
    ...
    #def _manOn(self, n):
    #    return self.__bases[n] != gsBASEEMPTY
    ...
    def _isEndGame(self):
        ...
        if self.__homeTeamUp and self.__fieldGameState.getNumOuts() == gsOUTSPERINNING:
            return True
    ...
    def handleStartAtBat(self, atBatEventObj):
        ...
        #OLD self.__bases[0] = atBatEventObj.getBatterGUID()
